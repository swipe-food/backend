...
class TestChefkochCrawler:
    ...
    @patch('application.crawler.crawlers.base_crawler.AbstractBaseCrawler._crawl_and_parse')
    @patch('application.crawler.crawlers.chefkoch_crawler.ChefkochCrawler.crawl_categories')
