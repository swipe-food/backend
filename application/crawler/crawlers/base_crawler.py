...
from application.crawler.fetch import URLQueue, AsyncFetcher, FetchResult
from application.crawler.scrapers.data_classes import ParsedCategory, ParsedRecipe, ParsedData, ParsedRecipeOverviewItem
